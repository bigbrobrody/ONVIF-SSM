...
The above commands also work when the SDP information is generated by a PHP file with paramaters supplied in the URL. For example sdp_text.php?camera=Name
